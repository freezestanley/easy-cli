...
class AdMoneyManage extends Component {
    ...
    return [
      ...
      },
      {
        ...
        render: (text, record, index) => {
          return (
            <div>
              <span className="theme cursor mar-r-8">垫资详情</span>
            </div>
          );
        },
      },
  ...
  goAddPage = () => {
    this.props.history.push('/clerk/addAdMoneyPage/addAdMoneyPage');
  }
    ...
    return (
      <div className={styles['ad-money-manage']}>
        <Spin spinning={this.state.loading} size="large">
          ...
          <Button type="primary" onClick={this.goAddPage}>添加</Button>
          {/* 表格 */}
          <Table
