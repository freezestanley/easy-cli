  ...
  <div class="page">
    ...
    <div class="table-box">
      <basic-table v-loading="loading" stripe :data="list" :col-configs="colConfigs">
        <!-- 2019-7-11<el-table-column slot="repayCorpName" label="还款企业1" width="150px" show-overflow-tooltip>
        ...
        <el-table-column slot="opt" label="操作" width="240px" fixed="right">
          <template slot-scope="scope">
            <div>
              ...
              <el-button v-if="checkPermission('repay-manage-list__contract')" type="text" @click="viewContract(scope.row)">查看合约</el-button>
            </div>
          </template>
        </el-table-column>
        <div slot="append">
...
export default {
  ...
  methods: {
    getData() {
      CommonApi.queryRepayPlanForChain({
        ...this.ruleForm,
        corpNo: this.$store.getters.userInfo.corpNo,
